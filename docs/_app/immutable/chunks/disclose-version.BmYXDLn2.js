...
function w(n, t) {
	...
	return () => {
		...
		var d = _ ? document.importNode(a, !0) : a.cloneNode(!0);
		if (e) {
			var m = f(d),
				l = d.lastChild;
			r(m, l);
...
function x(n = '') {
	...
	var e = o;
	return e.nodeType !== 3 && (e.before((e = i())), h(e)), r(e, e), e;
}
function M() {
	if (s) return r(o, null), o;
...
export { N as a, x as b, M as c, r as d, w as t };
//# sourceMappingURL=disclose-version.BmYXDLn2.js.map
